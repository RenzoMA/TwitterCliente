package com.android.renzo.twitterclient.main.ui;
...
import com.android.renzo.twitterclient.LoginActivity;
...
import com.android.renzo.twitterclient.main.ui.adapters.MainSectionsPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupAdapter();
        setTitle(getString(R.string.hello_user,Twitter.getSessionManager().getActiveSession().getUserName()));
